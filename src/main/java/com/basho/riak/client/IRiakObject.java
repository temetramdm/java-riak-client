...
public interface IRiakObject extends Iterable<RiakLink> {
   ...
   *
   * @param riakLink a {@link RiakLink}
   ...
   *
   * @param key the name of the user meta data item
   ...
   *
   * @param contentType the content-type of this object's value (EG
  ...
  int binIndexSize(BinIndex binIndex);
  ...
  int intIndexSize(IntIndex intIndex);

  /**
   * Remove a {@link BinIndex} from this RiakObject.
   *
   * @param index the name of the bin index to remove
   * @return this RiakObject
   */
   ...
   *
   * @param index the name of the int index to remove
   * @return this RiakObject
   */
